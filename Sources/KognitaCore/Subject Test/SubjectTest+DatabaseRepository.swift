//
//  SubjectTest+DatabaseRepository.swift
//  KognitaCore
//
...
extension SubjectTest {
    ...
    /// A database implementation of a `SubjectTestRepository`
    public struct DatabaseRepository: SubjectTestRepositoring, DatabaseConnectableRepository {
        ...
        /// The subject repository to user
        private let subjectRepository: SubjectRepositoring

        /// The test session repository to use
